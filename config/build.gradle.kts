...
android {
    namespace = "com.voski.wallet"
    compileSdk = 35
    defaultConfig {
        applicationId = "com.voski.wallet"
        minSdk = 26
        targetSdk = 35
        versionCode = 107
    ...
    buildTypes {
        ...
        applicationVariants.all {
            outputs.forEach {
                val apkName = "voski-${defaultConfig.versionCode}-${defaultConfig.versionName}-${chain.drop(1).dropLast(1)}-${buildType.name}.apk"
...
dependencies {
    implementation(project(":voski-shared"))
