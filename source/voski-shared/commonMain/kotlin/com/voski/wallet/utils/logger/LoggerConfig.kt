...
package com.voski.wallet.utils.logger
 ...
 */
data class VoskiLoggerConfig(private val platformContext: PlatformContext): LoggerConfig {
    override val logWriterList: List<LogWriter> = voskiLogWriters(platformContext)
 ...
 */
expect fun voskiLogWriters(ctx: PlatformContext): List<LogWriter>