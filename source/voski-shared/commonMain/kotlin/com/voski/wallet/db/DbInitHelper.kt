...
import com.voski.wallet.db.sqldelight.*
...
object ContactInfoAdapter : ColumnAdapter<ContactInfo, ByteArray> {
    override fun decode(databaseValue: ByteArray): ContactInfo =
        com.voski.wallet.db.serialization.contacts.Serialization.deserialize(databaseValue).getOrNull()
            ?: throw RuntimeException("cannot deserialize ${databaseValue.toHexString()}")

    override fun encode(value: ContactInfo): ByteArray = com.voski.wallet.db.serialization.contacts.Serialization.serialize(value)
}