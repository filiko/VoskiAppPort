...
package com.voski.wallet.db.migrations.v10.types
...
import com.voski.wallet.db.migrations.v11.types.liquidityads.FundingFeeData
import com.voski.wallet.db.migrations.v10.json.ByteVector32Serializer
import com.voski.wallet.db.migrations.v10.json.ByteVectorSerializer
import com.voski.wallet.db.migrations.v10.json.MilliSatoshiSerializer
import com.voski.wallet.db.migrations.v10.json.OutpointSerializer
import com.voski.wallet.db.migrations.v10.json.SatoshiSerializer
import com.voski.wallet.db.migrations.v10.json.UUIDSerializer
import com.voski.wallet.db.migrations.v11.types.liquidityads.FundingFeeData.Companion.asCanonical
import com.voski.wallet.utils.extensions.deriveUUID
...
private sealed class IncomingReceivedWithData {
    ...
    sealed class NewChannel : IncomingReceivedWithData() {
        @Serializable
        @SerialName("com.voski.wallet.db.payments.IncomingReceivedWithData.NewChannel.V0")
    ...
    sealed class Part : IncomingReceivedWithData() {
        ...
        sealed class Htlc : Part() {
            ...
            @Serializable
            @SerialName("com.voski.wallet.db.payments.IncomingReceivedWithData.Part.Htlc.V0")
            data class V0(
            ...
            @Serializable
            @SerialName("com.voski.wallet.db.payments.IncomingReceivedWithData.Part.Htlc.V1")
            data class V1(
        ...
        sealed class NewChannel : Part() {
            ...
            @Serializable
            @SerialName("com.voski.wallet.db.payments.IncomingReceivedWithData.Part.NewChannel.V0")
            data class V0(
                val amount: MilliSatoshi,
            ...
            @Serializable
            @SerialName("com.voski.wallet.db.payments.IncomingReceivedWithData.Part.NewChannel.V1")
            data class V1(
                val id: UUID,
                val amount: MilliSatoshi,
                val fees: MilliSatoshi,
            ...
            @Serializable
            @SerialName("com.voski.wallet.db.payments.IncomingReceivedWithData.Part.NewChannel.V2")
            data class V2(
                val amount: MilliSatoshi,
        ...
        sealed class SpliceIn : Part() {
            @Serializable
            @SerialName("com.voski.wallet.db.payments.IncomingReceivedWithData.Part.SpliceIn.V0")
            data class V0(
                val amount: MilliSatoshi,
                val serviceFee: MilliSatoshi,
                val miningFee: Satoshi,
        ...
        sealed class FeeCredit : Part() {
            @Serializable
            @SerialName("com.voski.wallet.db.payments.IncomingReceivedWithData.Part.FeeCredit.V0")
            data class V0(
                val amount: MilliSatoshi
            ) : FeeCredit()
        }
