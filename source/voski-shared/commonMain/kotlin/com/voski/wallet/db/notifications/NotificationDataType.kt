...
package com.voski.wallet.db.notifications
...
internal sealed class NotificationData {
    ...
    companion object {
        ...
        private fun Notification.asDb(): NotificationData = when (this) {
            ...
            is com.voski.wallet.data.WatchTowerOutcome.Nominal -> WatchTowerOutcome.Nominal.V0(channelsWatchedCount)
            is com.voski.wallet.data.WatchTowerOutcome.RevokedFound -> WatchTowerOutcome.RevokedFound.V0(channels)
            is com.voski.wallet.data.WatchTowerOutcome.Unknown -> WatchTowerOutcome.Unknown.V0
        }
    }
}
