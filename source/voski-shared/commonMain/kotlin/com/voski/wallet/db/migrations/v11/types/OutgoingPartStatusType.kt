...
sealed class OutgoingPartStatusData {
    ...
    sealed class Succeeded : OutgoingPartStatusData() {
        @Serializable
        @SerialName("com.voski.wallet.db.payments.OutgoingPartStatusData.Succeeded.V0")
        data class V0(@Serializable val preimage: ByteVector32) : Succeeded()
    }

    sealed class Failed : OutgoingPartStatusData() {
        @Serializable
        @SerialName("com.voski.wallet.db.payments.OutgoingPartStatusData.Failed.V0")
        data class V0(val remoteFailureCode: Int?, val details: String) : Failed()

        @Serializable
        @SerialName("com.voski.wallet.db.payments.OutgoingPartStatusData.Failed.V1")
