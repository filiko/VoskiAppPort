...
package com.voski.wallet.db.migrations.v11.types
...
sealed class OutgoingStatusData {
    ...
    sealed class SucceededOffChain : OutgoingStatusData() {
        @Serializable
        @SerialName("com.voski.wallet.db.payments.OutgoingStatusData.SucceededOffChain.V0")
        data class V0(@Serializable val preimage: ByteVector32) : SucceededOffChain()
    }

    sealed class SucceededOnChain : OutgoingStatusData() {
        @Serializable
        @SerialName("com.voski.wallet.db.payments.OutgoingStatusData.SucceededOnChain.V0")
        data class V0(
        ...
        @Serializable
        @SerialName("com.voski.wallet.db.payments.OutgoingStatusData.SucceededOnChain.V1")
        data object V1 : SucceededOnChain()
    }

    sealed class Failed : OutgoingStatusData() {
        @Serializable
        @SerialName("com.voski.wallet.db.payments.OutgoingStatusData.Failed.V0")
