...
package com.voski.wallet.db.migrations.v11.types.liquidityads
...
sealed class PaymentDetailsData {
    sealed class ChannelBalance : PaymentDetailsData() {
        @Serializable
        @SerialName("com.voski.wallet.db.payments.liquidityads.PaymentDetailsData.ChannelBalance.V0")
        data object V0 : ChannelBalance()
    }

    sealed class FutureHtlc : PaymentDetailsData() {
        @Serializable
        @SerialName("com.voski.wallet.db.payments.liquidityads.PaymentDetailsData.FutureHtlc.V0")
        data class V0(val paymentHashes: List<ByteVector32>) : FutureHtlc()
    }

    sealed class FutureHtlcWithPreimage : PaymentDetailsData() {
        @Serializable
        @SerialName("com.voski.wallet.db.payments.liquidityads.PaymentDetailsData.FutureHtlcWithPreimage.V0")
    ...
    sealed class ChannelBalanceForFutureHtlc : PaymentDetailsData() {
        @Serializable
        @SerialName("com.voski.wallet.db.payments.liquidityads.PaymentDetailsData.ChannelBalanceForFutureHtlc.V0")
