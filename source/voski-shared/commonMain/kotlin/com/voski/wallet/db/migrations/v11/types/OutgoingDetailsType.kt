...
sealed class OutgoingDetailsData {
    ...
    sealed class Normal : OutgoingDetailsData() {
        @Serializable
        @SerialName("com.voski.wallet.db.payments.OutgoingDetailsData.Normal.V0")
        data class V0(val paymentRequest: String) : Normal()
    }

    sealed class SwapOut : OutgoingDetailsData() {
        @Serializable
        @SerialName("com.voski.wallet.db.payments.OutgoingDetailsData.SwapOut.V0")
    ...
    sealed class Blinded : OutgoingDetailsData() {
        @Serializable
        @SerialName("com.voski.wallet.db.payments.OutgoingDetailsData.Blinded.V0")
    ...
    sealed class Closing : OutgoingDetailsData() {
        @Serializable
        @SerialName("com.voski.wallet.db.payments.OutgoingDetailsData.Closing.V0")
        data class V0(
