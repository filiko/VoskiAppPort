...
import com.voski.wallet.db.migrations.v11.types.liquidityads.PaymentDetailsData.Companion.asCanonical
...
sealed class PurchaseData {
    sealed class Standard : PurchaseData() {
        @Serializable
        @SerialName("com.voski.wallet.db.payments.liquidityads.PurchaseData.Standard.V0")
        data class V0(
            val amount: Satoshi,
    ...
    sealed class WithFeeCredit : PurchaseData() {
        @Serializable
        @SerialName("com.voski.wallet.db.payments.liquidityads.PurchaseData.WithFeeCredit.V0")
        data class V0(
            val amount: Satoshi,
            val miningFees: Satoshi,
            val serviceFee: Satoshi,
