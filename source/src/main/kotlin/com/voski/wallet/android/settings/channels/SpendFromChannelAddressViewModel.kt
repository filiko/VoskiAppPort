...
import com.voski.wallet.utils.channels.SpendChannelAddressHelper
import com.voski.wallet.utils.channels.SpendChannelAddressResult
...
class SpendFromChannelAddressViewModel(
    private val business: VoskiBusiness
) : ViewModel() {
