...
import com.voski.wallet.utils.channels.ChannelsImportHelper
import com.voski.wallet.utils.channels.ChannelsImportResult
...
class ImportChannelsDataViewModel(val peerManager: PeerManager, val nodeParamsManager: NodeParamsManager) : ViewModel() {
    ...
    fun importData(data: String, business: VoskiBusiness) {
