...
import com.voski.wallet.android.VoskiApplication
import com.voski.wallet.android.security.EncryptedSeed
import com.voski.wallet.android.security.SeedManager
import com.voski.wallet.android.utils.SystemNotificationHelper
...
import com.voski.wallet.data.StartupParams
import com.voski.wallet.data.inFlightPaymentsCount
import com.voski.wallet.managers.AppConfigurationManager
import com.voski.wallet.managers.CurrencyManager
import com.voski.wallet.managers.NodeParamsManager
...
class NodeService : Service() {
    ...
    override fun onCreate() {
        ...
        internalData = (applicationContext as VoskiApplication).internalDataRepository
    ...
    private suspend fun doStartBusiness(
        ...
        val application = (applicationContext as? VoskiApplication) ?: throw RuntimeException("invalid context type, should be VoskiApplication")
    ...
    private suspend fun monitorFcmToken(business: VoskiBusiness) {
