...
import com.voski.wallet.android.LocalBitcoinUnits
import com.voski.wallet.android.LocalFiatCurrencies
import com.voski.wallet.R
import com.voski.wallet.android.Screen
import com.voski.wallet.android.business
import com.voski.wallet.android.components.AmountView
import com.voski.wallet.android.components.Clickable
import com.voski.wallet.android.components.dialogs.IconPopup
import com.voski.wallet.android.components.TextWithIcon
import com.voski.wallet.android.components.openLink
import com.voski.wallet.android.components.txUrl
import com.voski.wallet.android.primaryFiatRate
import com.voski.wallet.android.navController
import com.voski.wallet.android.payments.details.technical.TechnicalIncomingBolt11
import com.voski.wallet.android.payments.details.technical.TechnicalIncomingBolt12
import com.voski.wallet.android.payments.details.technical.TechnicalIncomingLegacyPayToOpen
import com.voski.wallet.android.payments.details.technical.TechnicalIncomingLegacySwapIn
import com.voski.wallet.android.payments.details.technical.TechnicalIncomingNewChannel
import com.voski.wallet.android.payments.details.technical.TechnicalIncomingSpliceIn
import com.voski.wallet.android.payments.details.technical.TechnicalOutgoingAutoLiquidity
import com.voski.wallet.android.payments.details.technical.TechnicalOutgoingChannelClose
import com.voski.wallet.android.payments.details.technical.TechnicalOutgoingLightning
import com.voski.wallet.android.payments.details.technical.TechnicalOutgoingManualLiquidity
import com.voski.wallet.android.payments.details.technical.TechnicalOutgoingSplice
import com.voski.wallet.android.payments.details.technical.TechnicalOutgoingSpliceCpfp
import com.voski.wallet.android.utils.converters.AmountConverter.toFiat
import com.voski.wallet.android.utils.converters.AmountFormatter.toPrettyString
import com.voski.wallet.android.utils.converters.DateFormatter.toAbsoluteDateTimeString
import com.voski.wallet.android.utils.converters.MSatDisplayPolicy
import com.voski.wallet.android.utils.copyToClipboard
import com.voski.wallet.android.utils.mutedBgColor
