...
import com.voski.wallet.android.*
import com.voski.wallet.R
import com.voski.wallet.android.components.*
import com.voski.wallet.android.home.TorDisconnectedDialog
import com.voski.wallet.android.services.ChannelsWatcher
...
import com.voski.wallet.data.WatchTowerOutcome
    ...
    when (notice) {
        ...
        Notice.CriticalUpdateAvailable -> {
            ImportantNotification(
                ...
                onActionClick = { openLink(context, "https://play.google.com/store/apps/details?id=com.voski.wallet.mainnet") }
            )
        }
