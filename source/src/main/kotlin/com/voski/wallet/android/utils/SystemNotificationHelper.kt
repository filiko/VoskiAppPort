...
package com.voski.wallet.android.utils
...
import com.voski.wallet.android.utils.converters.DateFormatter.toAbsoluteDateString
...
object SystemNotificationHelper {
    ...
    fun notifyRunningHeadless(context: Context): Notification {
        return NotificationCompat.Builder(context, HEADLESS_NOTIF_CHANNEL).apply {
            ...
            setSmallIcon(R.drawable.ic_voski_outline)
        }.build().also {
