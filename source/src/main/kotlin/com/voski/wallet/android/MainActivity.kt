...
import com.voski.wallet.android.services.HceService
import com.voski.wallet.android.services.NodeService
import com.voski.wallet.android.utils.PhoenixAndroidTheme
import com.voski.wallet.android.utils.nfc.NfcReaderCallback
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            val businessState = (application as VoskiApplication).business.collectAsState()
    ...
    private fun tryReconnect() {
        lifecycleScope.launch {
            (application as? VoskiApplication)?.business?.value?.let { business ->
    ...
    private fun Intent.fixUri() {
        ...
        if (scheme == "voski" && ssp != null && (ssp.startsWith("lnbc") || ssp.startsWith("lntb") || ssp.startsWith("lnurl") || ssp.startsWith("lno"))) {
