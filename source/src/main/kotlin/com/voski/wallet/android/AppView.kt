...
import com.voski.wallet.BuildConfig
...
import com.voski.wallet.android.components.openLink
import com.voski.wallet.android.components.auth.screenlock.ScreenLockPrompt
import com.voski.wallet.android.home.HomeView
import com.voski.wallet.android.initwallet.create.CreateWalletView
import com.voski.wallet.android.initwallet.InitWallet
import com.voski.wallet.android.initwallet.restore.RestoreWalletView
import com.voski.wallet.android.intro.IntroView
import com.voski.wallet.android.payments.details.PaymentDetailsView
import com.voski.wallet.android.payments.history.PaymentsExportView
import com.voski.wallet.android.payments.history.PaymentsHistoryView
import com.voski.wallet.android.payments.send.liquidity.RequestLiquidityView
import com.voski.wallet.android.payments.receive.ReceiveView
import com.voski.wallet.android.payments.send.SendView
import com.voski.wallet.android.services.NodeServiceState
import com.voski.wallet.android.settings.AboutView
import com.voski.wallet.android.settings.AppAccessSettings
import com.voski.wallet.android.settings.DisplayPrefsView
import com.voski.wallet.android.settings.electrum.ElectrumView
import com.voski.wallet.android.settings.ExperimentalView
import com.voski.wallet.android.settings.ForceCloseView
import com.voski.wallet.android.settings.LogsView
import com.voski.wallet.android.settings.MutualCloseView
import com.voski.wallet.android.settings.NotificationsView
import com.voski.wallet.android.settings.PaymentSettingsView
import com.voski.wallet.android.settings.ResetWallet
import com.voski.wallet.android.settings.SettingsContactsView
import com.voski.wallet.android.settings.SettingsView
import com.voski.wallet.android.settings.TorConfigView
import com.voski.wallet.android.settings.channels.ChannelDetailsView
import com.voski.wallet.android.settings.channels.ChannelsView
import com.voski.wallet.android.settings.channels.ImportChannelsData
import com.voski.wallet.android.settings.channels.SpendFromChannelAddress
import com.voski.wallet.android.settings.displayseed.DisplaySeedView
import com.voski.wallet.android.settings.fees.AdvancedIncomingFeePolicy
import com.voski.wallet.android.settings.fees.LiquidityPolicyView
import com.voski.wallet.android.settings.walletinfo.FinalWalletInfo
import com.voski.wallet.android.settings.walletinfo.FinalWalletRefundView
import com.voski.wallet.android.settings.walletinfo.SendSwapInRefundView
import com.voski.wallet.android.settings.walletinfo.SwapInAddresses
import com.voski.wallet.android.settings.walletinfo.SwapInSignerView
import com.voski.wallet.android.settings.walletinfo.SwapInWallet
import com.voski.wallet.android.settings.walletinfo.WalletInfoView
import com.voski.wallet.android.startup.StartupView
import com.voski.wallet.android.utils.appBackground
import com.voski.wallet.android.utils.datastore.PreferredBitcoinUnits
import com.voski.wallet.android.utils.extensions.findActivitySafe
import com.voski.wallet.android.utils.logger
import com.voski.wallet.data.BitcoinUnit
import com.voski.wallet.data.ExchangeRate
import com.voski.wallet.data.FiatCurrency
...
private fun UpgradeRequiredBlockingDialog() {
    ...
    Dialog(
        ...
        Button(
            ...
            onClick = { openLink(context = context, link = "https://play.google.com/store/apps/details?id=com.voski.wallet.mainnet") },
