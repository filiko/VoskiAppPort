...
class VoskiApplication : Application() {

    private val log = LoggerFactory.getLogger(this::class.java)
    private val _business = MutableStateFlow<VoskiBusiness?>(null)
    ...
    override fun onCreate() {
        super.onCreate()
        _business.value = VoskiBusiness(PlatformContext(applicationContext))
    ...
    fun resetBusiness() {
        _business.value = VoskiBusiness(PlatformContext(this))
